      ...
      <div>
        <div className='flex flex-row justify-between p-5 md:px-32 px-5 bg-transparent shadow-[0_3px_10px_rgba(0,0,0,0.2)]'>
            ...
            <nav className='hidden md:flex flex-row items-center text-sky-900 text-xl ml-60 font-bold gap-6'>
                ...
                <Link href='#nosotros' className='hover:text-teal-500 transition-all cursor-pointer'>
                 Nosotros
                </Link>
                <Link href='#planes' className='hover:text-teal-500 transition-all cursor-pointer'>
                 Planes
                </Link>
                <Link href='#contacto' className='hover:text-teal-500 transition-all cursor-pointer'>
                 Contacto
                </Link>
            </nav>
        ...
        <Link href='/' className='hover:text-teal-500 transition-all cursor-pointer' onClick={closeMenu}>
                ...
                <Link href='#nosotros' className='hover:text-teal-500 transition-all cursor-pointer' onClick={closeMenu}>
                 Nosotros
                </Link>
                <Link href='#planes' className='hover:text-teal-500 transition-all cursor-pointer' onClick={closeMenu}>
                 Planes
                </Link>
                <Link href='#contacto' className='hover:text-teal-500 transition-all cursor-pointer' onClick={closeMenu}>
                  Contacto
                </Link>
        </div>
        </div>
